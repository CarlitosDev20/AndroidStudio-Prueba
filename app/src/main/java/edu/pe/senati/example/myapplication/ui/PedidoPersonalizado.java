...
public class PedidoPersonalizado extends Fragment {
    FragmentPedidoPersonalizadoBinding binding;
    View view;
    Context context;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentPedidoPersonalizadoBinding.inflate(inflater, container,false);
